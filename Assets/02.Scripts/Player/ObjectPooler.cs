    ...
    public class ObjectPooler : MonoBehaviour
    {
        ...
        private bool InitializePool()
        {
            ...
            if (objectToPool == null)
            {
                ...
                Debug.LogError("[ObjectPooler] objectToPool is not assigned.");
                return false;
            }
            ...
            if (amountToPool <= 0)
            {
                ...
                Debug.LogError($"[ObjectPooler] amountToPool must be greater than 0. Current: {amountToPool}");
                return false;
            }
            ...
            Debug.Log($"[ObjectPooler] Initialized pool with {pooledObjects.Count} bullets.");
            return true;
        }
        ...
        public GameObject GetPooledObject()
        {
            ...
            {
                Debug.LogWarning($"[ObjectPooler] GetPooledObject failed: {GetDebugStatus()}");
                return null;
            }

            if (pooledObjects == null)
            {
                Debug.LogWarning("[ObjectPooler] pooledObjects is null.");
                return null;
            }

            if (pooledObjects.Count == 0)
            {
                Debug.LogWarning("[ObjectPooler] pooledObjects is empty.");
                return null;
            }
