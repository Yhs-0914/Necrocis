    ...
    private void ApplyStat(StackStatType statType)
    {
        ...
        switch (statType)
        {
            ...
            case StackStatType.AttackRange:
                runtimeStats.AddModifier(CharacterStatType.AttackRange, attackRangePercentIncrease / 100f, CharacterStatModifierMode.PercentAdd, source);
                break;
