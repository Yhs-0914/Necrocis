...
namespace Necrocis
{
    ...
    public sealed class MainMenuController : MonoBehaviour
    {
        ...
        private Button resetBossProgressButton;
        ...
        private void CreateMainMenu(Transform canvas)
        {
            ...
            startButton.onClick.AddListener(() => AudioManager.Instance?.PlaySFX("ButtonClick"));
            quitButton.onClick.AddListener(() => AudioManager.Instance?.PlaySFX("ButtonClick"));
        ...
        private void CreateSettingsOverlay(Transform canvas)
        {
            ...
            resetBossProgressButton = CreateMenuButton(panel.transform, "ResetBossProgressButton", "보스 진행도 초기화", new Vector2(0f, -105f));
            RectTransform resetRect = resetBossProgressButton.GetComponent<RectTransform>();
            resetRect.sizeDelta = new Vector2(360f, 52f);
            Text resetLabel = resetBossProgressButton.GetComponentInChildren<Text>();
            resetLabel.fontSize = 25;
            resetLabel.alignment = TextAnchor.MiddleCenter;
            resetBossProgressButton.onClick.AddListener(ResetBossProgress);

            settingsBackButton = CreateMenuButton(panel.transform, "SettingsBackButton", "돌아가기", new Vector2(0f, -175f));
            RectTransform backRect = settingsBackButton.GetComponent<RectTransform>();
            backRect.sizeDelta = new Vector2(360f, 52f);
        ...
        private void ResetBossProgress()
        {
            if (GameManager.Instance != null)
            {
                GameManager.Instance.ResetBossProgress();
            }
            else
            {
            ...
            Text label = resetBossProgressButton != null
                ? resetBossProgressButton.GetComponentInChildren<Text>()
                : null;
            if (label != null)
            {
                label.text = "초기화 완료";
